...
from qfluentwidgets import (SmoothScrollArea, PushButton, ToolButton, FluentIcon,
                            IconWidget, Theme, ToolTipFilter, TitleLabel, CaptionLabel,
...
class GalleryInterface(SmoothScrollArea):
    """ Gallery interface """
